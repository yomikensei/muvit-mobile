...
class ViewRide extends Component {
  render() {
    const { navigation: { navigate }, ride: { location_origin, location_destination, createdAt, bill } } = this.props;
    return (
      <Container style={styles.container}>
        <AppHeader showBackButton goBack={() => navigate('HomeTab')} headerText="Ride History" icon="md-list-box" />
